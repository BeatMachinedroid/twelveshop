					...
					{        
									if($fsize>=1000000)
									...
									else
										{
												...
												$sql = "INSERT INTO kue(idkate,namakue,deskripsi,harga,gambar) VALUE('".$_POST['kategori']."','".$_POST['kue']."','".$_POST['deskripsi']."','".$_POST['harga']."','".$fnew."')";  // store the submited data ino the database :images
                ...
                <!-- Start Page Content -->
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text">Add Kue</h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="kue" class="form-control" placeholder="Morzirella">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" name="deskripsi" class="form-control form-control-danger" placeholder="Deskripsi">
                                                    </div>
                                            </div>
                                            <!--/span-->
                                        </div>
