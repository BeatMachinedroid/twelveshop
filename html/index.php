				...
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<div class="row product_name">
							<h4><?php echo $row['namakue']; ?></h4>
						</div>
						<div class="row product_footer">
							<p class="pull-left"><b><?php echo $row['harga']; ?></b></p>
							<span class="pull-right"><a href="add_cart.php?id=<?php echo $row['idkue']; ?>" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-plus"></span> Cart</a></span>
						</div>
					</div>
				</div>
			</div>
